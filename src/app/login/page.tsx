    ...
    <main className="min-h-screen bg-bg flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted text-sm mt-3 font-body">Sign in to your account</p>
        </div>

        <div className="bg-white border border-border rounded-2xl p-8" style={{boxShadow:'0 4px 24px rgba(15,33,68,0.08)'}}>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-body font-medium text-navy mb-1.5">Email</label>
            ...
            <div>
              <label className="block text-sm font-body font-medium text-navy mb-1.5">Password</label>
          ...
          <div className="mt-6 p-4 bg-bg border border-border rounded-xl">
            <p className="text-xs font-mono text-muted mb-2 uppercase tracking-wider">Demo Accounts</p>
        ...
        <p className="text-center text-muted text-sm mt-5 font-body">
          No account? <Link href="/register" className="text-brand hover:text-navy font-medium transition-colors">Register here</Link>
        </p>
      </div>
    </main>
  );
